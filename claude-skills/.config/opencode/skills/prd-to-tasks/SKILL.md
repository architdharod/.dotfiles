...
Ask the user for the PRD (or URL or location of the PRD).

If the PRD is not already in your context window, ask the user for the location.
...
Break the PRD into **tracer bullet** tasks. Each tasks is a thin vertical slice that cuts through ALL integration layers end-to-end, NOT a horizontal slice of one layer.
...
For each approved slice, create an tasks.md with tasks. Use the tasks body template below.
...
checklist to mark if a task is finished or not
